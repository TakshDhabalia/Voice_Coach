...
def preprocess_audio(file_path):
    ...
    mfccs = librosa.util.fix_length(mfccs, size=32, axis=1)  # Fix the length to 32 frames
    return mfccs
...
if __name__ == '__main__':
    audio_folder = ''  # Replace with your actual path
    output_folder = ''  # Replace with your actual path
